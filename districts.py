# This file contains the configuration data for state districts.
# By separating this data, the main scraper code is cleaner and easier to read.

STATE_DISTRICTS = {
    "Andaman and Nicobar": ["Nicobar", "North and Middle Andaman", "South Andaman"],
    "Andhra Pradesh": [
        'Alluri Sitharama Raju', 'Anakapalli', 'Ananthapur', 'Annamayya', 'Bapatla', 'Chittoor', 
        'Dr.B.R.Ambedkar Konaseema', 'East Godavari', 'Eluru', 'Guntur', 'Kakinada', 'Krishna', 'Kurnool', 'Nandyal',
        'NTR', 'Palnadu', 'Parvathipuram Manyam', 'Prakasam', 'SPSR Nellore', 'Sri Sathya Sai', 
        'Srikakulam', 'Tirupati', 'Visakhapatnam', 'Vizianagaram', 'West Godavari', 'Y.S.R.'
    ],
    "Arunachal Pradesh": [
    ...
    "Chattisgarh": [
        "Balod", "Baloda Bazar", "Balrampur", "Bastar", "Bemetara", "Bijapur", "Bilaspur", "Dantewada (Dakshin Bastar)",
        "Dhamtari", "Durg", "Gariyaband", "Janjgir-Champa", "Jashpur", "Kabirdham (Kawardha)", "Kanker (Uttar Bastar)",
    ...
    "Gujarat": [
        ...
        "Panchmahal (Godhra)", "Patan", "Porbandar", "Rajkot", "Sabarkantha (Himmatnagar)", "Surat",
        "Surendranagar", "Tapi (Vyara)", "Vadodara", "Valsad"
    ],
    "Haryana": [
        "Ambala", "Bhiwani", "Charkhi Dadri", "Faridabad", "Fatehabad", "Gurugram (Gurgaon)", "Hisar", "Jhajjar",
    ...
    "Jharkhand": [
        ...
        "Hazaribag", "Jamtara", "Khunti", "Koderma", "Latehar", "Lohardaga", "Pakur", "Palamu", "Ramgarh",
    ...
    "Karnataka": [
        ...
        "Bengaluru (Bangalore) Urban", "Bidar", "Chamarajanagar", "Chikkaballapur", "Chikkamagaluru (Chikmagalur)",
        ...
        "Tumakuru (Tumkur)", "Udupi", "Uttara Kannada", "Vijayanagara", "Yadgir"
    ],
    "Kerala": [
    ...
    "Odisha": [
        ...
        "Gajapati", "Ganjam", "Jagatsinghapur", "Jajpur", "Jharsuguda", "Kalahandi", "Kandhamal", "Kendrapara",
    ...
    "Punjab": [
        ...
        "Pathankot", "Patiala", "Rupnagar (Ropar)", "Sahibzada Ajit Singh Nagar (Mohali)", "Sangrur", "Tarn Taran"
    ],
    "Rajasthan": [
    ...
    "Telangana": [
        ...
        'Peddapalli', 'Rajanna Sircilla', 'Ranga Reddy', 'Sangareddy', 'Siddipet', 'Suryapet', 'Vikarabad',
    ...
    "West Bengal": [
        ...
        "North 24 Parganas", "Paschim Medinipur (West Medinipur)", "Paschim (West) Burdwan",
